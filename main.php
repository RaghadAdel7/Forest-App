		...
		<div class="border-bottom" id="mainPage">
			...
			<div class="d-flex justify-content-center navbar navbar-light bg-light border-bottom">
				<nav class="navbar navbar-light bg-light py-0 justify-content-center" id="brand">
					<a class="navbar-brand" href="/">
						<span id="brandName">Forest App</span>
					</a>
					...
					<ul class="nav nav-pills justify-content-end">
						...
						<li>
						<img src="pomodoro-technique.png" width="34" height="35" style="position: relative;" alt="Pomodoro Technique" > <a  href="index.html">
						</a>
						</li>
					</ul>
				</nav>
				...
				<div class="row justify-content-end">
					<div class="col-6 px-0">
						<ul class="nav nav-pills">
							...
							<div class="col-lg-4 px-0"style="display: none;" >
			...
			<div class="container-fluid" style="text-align: center; position: relative;">
				<div class="row" >
					...
					<!-- Start, Give up Buttons -->
					<div class="col-12">
						<div class="container d-flex justify-content-around">
							<div class="row">

								<div class="col-md-4">
									<button type="button" class="button-pressed-effect btn btn-lg btn-success w-100 mb-3" id="startButton" style="background-color:#67d1ad;  position:relative; bottom:-120px;">Start</button>
								</div>

								<div class="col-md-4" style="display: none;">
									<button type="button" class="button-pressed-effect btn btn-danger btn-lg w-100 mb-3" id="stopButton" style="background-color: #2f8266;">Stop</button>
								</div>

								<div class="col-md-4 ">
									<button type="button" class="button-pressed-effect btn btn-secondary btn-lg w-100 mb-3" id="resetButton" style="position:relative; bottom:-130px;">Give Up</button>
								</div>
